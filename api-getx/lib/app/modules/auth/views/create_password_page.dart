...
class CreatePasswordPage extends StatelessWidget {
  ...
  final CreatePasswordController controller = CreatePasswordController.instance;
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("Create your new password", style: TextStyl.body(context).sm.regular),
                                  ],
                                ),
                              ),
                            ],
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FormInput.password(
                                    ...
                                    validator: (value) => Validator("New Password", value!).required().validate(),
                                  ),
                                  const SizedBox(height: kSpacer),
                                  FormLabel("Confirmation Password"),
                                  const SizedBox(height: kSpacer2),
                                  FormInput.password(
                                    ...
                                    leading: Icon(Icons.lock_outline),
                                    validator: (value) => Validator("Confirmation Password", value!)
                                        .required()
                                        .isEqual(
                                  ...
                                  const SizedBox(height: kSpacer),
                                  Button.block(
                                    key: ObjectKey("update_password_button"),
